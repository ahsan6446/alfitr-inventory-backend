...
const DEFAULT_PERMS = {
  'Super Admin': { viewPricing:true,  editPricing:true,  exportPricing:true, viewStockValue:true,  viewProfitMargin:true,  manageStock:true, createDN:true, manageInventory:true, manageUsers:true,  allowNegativeStock:true, manageQuotations:true, manageMaterialRequests:true },
  'Admin':       { viewPricing:true,  editPricing:true,  exportPricing:true, viewStockValue:true,  viewProfitMargin:true,  manageStock:true, createDN:true, manageInventory:true, manageUsers:false, allowNegativeStock:true, manageQuotations:true, manageMaterialRequests:true },
  'Storekeeper': { viewPricing:false, editPricing:false, exportPricing:false, viewStockValue:false, viewProfitMargin:false, manageStock:true, createDN:true, manageInventory:false, manageUsers:false, allowNegativeStock:false, manageQuotations:false, manageMaterialRequests:true },
  'Engineer':    { viewPricing:false, editPricing:false, exportPricing:false, viewStockValue:false, viewProfitMargin:false, manageStock:false, createDN:false, manageInventory:false, manageUsers:false, allowNegativeStock:false, manageQuotations:false, manageMaterialRequests:true },
  'Viewer':      { viewPricing:false, editPricing:false, exportPricing:false, viewStockValue:false, viewProfitMargin:false, manageStock:false, createDN:false, manageInventory:false, manageUsers:false, allowNegativeStock:false, manageQuotations:false, manageMaterialRequests:false },
};
