...
router.post('/', requirePermission('manageReports'), photoUpload, async (req, res) => {
  try {
    ...
    const report = {
      ...
      projectName:      jo.subject        || jo.projectName || jo.name || '',
      scopeOfWork:      jo.siteDetail     || '',
      location:         jo.location       || jo.siteDetail  || '',
      ...
      projectsIncharge: jo.projectsIncharge || '',
      preparedBy:       jo.preparedBy     || body.reportedBy || '',
